...
setInterval(async function () {
    ...
    switch (progress_reach) {
        case 0:
            ...
            await sleep()
            dogzy_text_a('I am <strong> Mr. OGGY! </strong>');
            await sleep()
            // Hi dog
    ...
    switch (progress_reach) {
        case 1:
            ...
            dogzy_user_option('About <strong>OGGY</strong>', 'Aboutjassi');
            resp('About <strong>OGGY</strong>', 'Aboutjassi', 3);
            scroll_down()
                        ...
                        setInterval(async function () {
                            switch (progress_reach) {
                                case 3.1:
                                    stop_loop(3.1);
                                    await sleep()
                                    dogzy_text_p("Hi myself OGGY, Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.")
                                    await sleep()
